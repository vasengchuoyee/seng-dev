...
export default function CustomerStories() {
    return (
        <div id='projects' className="px-4 sm:px-8 md:px-14 py-10 sm:py-10 md:py-10 bg-[var(--bg-color)]">
            <div className="flex justify-center items-center mb-6 px-6">
                <h1 className='flex text-[40px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 py-20'>
                    <FiActivity className="mr-2 text-blue-400" />
                    My Projects
                </h1>
            </div>
            <motion.div
                className="relative overflow-x-auto pb-4 scrollbar-none"
